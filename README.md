...
The full database, as well as all captured repository snapshots are available [Anonymous link]
...
This section will include more details about the demo provided in the repository, PeaTMOSS_demo.py. Once again, this method requires the PeaTMOSS.db file, which can be found in the [Anonymous Link]. Prior to running this demo, ensure that the conda environment has been created and activated, or you may run into errors. 
